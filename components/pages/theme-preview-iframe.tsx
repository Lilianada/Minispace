...
export function LayoutPreview({
  ...
  useEffect(() => {
    // Use an inline HTML preview instead of an API route to avoid 404 errors
    // This creates a data URI with the preview HTML
    const generatePreviewHTML = () => {
      ...
      return `
        ...
        <head>
          ...
          <title>${headerText || username} - Theme Preview</title>
          <style>
            ${commonCSS}
            ${themeCSS}
          </style>
    ...
    const getFontFamily = (font: string) => {
      switch (font) {
        ...
        case 'satoshi':
          return "'Satoshi', system-ui, sans-serif";
        case 'geist':
